                                                                                                   ...
                                                                                                   //estabelecendo os parâmetros para a conexão com o banco de dados especificado.
            {
                                                                                                   ...
                                                                                                   //o controle será passado para o bloco catch.
                {
                    ...
                    foreach (DataTable table in tables)
                    {
                        ...
                        {
                            dgvData.AutoGenerateColumns = true;                                    //O AutoGenerateColumns habilita a geração automática de colunas no DataGridView com base nos dados que foram retornados.
                            
                            dgvData.DataSource = setDiDati;                                        //O DataSource define o setDiDati como a fonte de dados para o DataGridView                            
                            
                            dgvData.DataMember = table.TableName;                                  //O DataMember especifica qual "tabela" dentro do DataSet será exibida e neste caso, a tabela é "Dati"                            
