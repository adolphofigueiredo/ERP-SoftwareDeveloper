...
{                                                          //A declaração de namespace organiza o código e evita conflitos de
    ...
    public class CorsiController : Controller              //O StudentiController é um controller que lida com as ações que
    ...
    {
        private readonly CorsiRepository _corsiRepository;
        ...
        public CorsiController(CorsiRepository corsiRepository)
        {                                                  //Este é o construtor da classe StudentiController. Ele é chamado toda
            ...
            _corsiRepository = corsiRepository;            //Este código atribui o repositório passado ao campo privado _studentiRepository.
                                                           //Com isso, o controlador pode usar _studentiRepository para interagir com
                                                           //a camada de dados.
        }
        public IActionResult Index([FromQuery] CorsoFilter filter)
                                                           ...
                                                           //os usuários podem usar para buscar ou filtrar estudantes.
        {
            ...
            List<CorsoDto> corsiDto = elementiTrovati      //Aqui está sendo criada uma lista do tipo StudenteDto. Um DTO (Data
                ...
                .Select(r => CorsoMapper.Map(r))           //Aqui a função Select é um método de LINQ que mapeia cada elemento
