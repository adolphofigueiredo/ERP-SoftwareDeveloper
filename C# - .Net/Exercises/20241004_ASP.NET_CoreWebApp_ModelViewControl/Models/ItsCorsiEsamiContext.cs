...
namespace _20241004_ASP.NET_CoreWebApp_ModelViewControl.Models
{
                                                                               ...
                                                                               //operações de banco de dados, incluindo consultas e salvamento de dados.
    {
        ...
        public ItsCorsiEsamiContext(DbContextOptions<ItsCorsiEsamiContext> dbContext) : base(dbContext)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)   
                                                                               //O método protected override está indica que esta implementação customizada irá
...
//RELAZIONI
            ...
            modelBuilder.Entity<CorsoEntity>()                                 //Ponto em que se cria a relação
                ...
                .WithOne(p => p.Corso)                                         //O WithOne define que a entidade relacionada (StudenteEntity) tem uma relação
