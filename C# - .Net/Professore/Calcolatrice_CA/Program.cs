    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            switch (operazione)
            {
                ...
                case "-": r = n1 - n2; break;
                //case "*": r =  n1 * n2; break;
                case "*": r = Moltiplica(n1, n2); break; 
                //case "/": r =  n1 / n2; break;
                case "/": r = Dividi(n1, n2, out resto); break;
            }

            if (operazione == "/")
                Console.WriteLine("risultato: " + r + " (resto: " + resto + ") - è un numero " + (r % 2 == 0 ? "PARI" : "DISPARI"));
            else
        ...
        public static int Moltiplica(int valore, int numeroVolte)
        {
            int valoreRitorno = 0;
            for (int i = 0; i < numeroVolte; i++)
            {
                valoreRitorno += valore;

            }
            return valoreRitorno;
        }

        public static int Dividi(int dividendo, int divisore, out int resto)
        {
            int valoreRitorno = 0;
            do
            {
