'''
Before importing the emoji library, you need to install it through the command line (cmd).
It is necessary to access it and type: "pip install emoji"
https://www.webfx.com/tools/emoji-cheat-sheet/
https://github.com/carpedm20/emoji?tab=readme-ov-file
'''

# Seção de importação da biblioteca
