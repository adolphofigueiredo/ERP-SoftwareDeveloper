...
Create a program that asks the user to enter their age and field of study. The
field of study is represented using the following scheme:

➔ 1 -> Computer Science
➔ 2 -> Physics
➔ 3 -> Mathematics

The output should show a message similar to the following:
